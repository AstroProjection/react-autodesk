...
function markup3d(viewer, options) {
  ...
  this.pointCloud = undefined; // three js point-cloud mesh object
  this.line3d = undefined; // three js point-cloud mesh object
  this.camera = viewer.impl.camera;
  this.hovered = undefined; // index of selected pointCloud id, based on markupItems array
  this.selected = undefined; // index of selected pointCloud id, based on markupItems array
  this.label = undefined; // x,y div position of selected pointCloud. updated on mouse-move
  this.offset = undefined; // global offset
